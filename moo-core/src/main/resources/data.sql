...
INSERT INTO seats (
    store_id, user_id, seat_number, start_at, expired_at,
    seat_type, seat_status, created_at, updated_at
) VALUES
      (1, NULL, 1, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL, 2, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL, 3, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL, 4, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL, 5, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL, 6, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL, 7, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL, 8, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL, 9, NULL, NULL, 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL, 10, NULL, NULL, 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);