...
VALUES
    ('moo', '홍길동', '든든한 한끼를 드립니다', '02-1234-5678', CURRENT_TIMESTAMP, CAST('09:00:00' AS TIME), CAST('22:00:00' AS TIME), 0, '123-45-67890', '서울특별시 강서구 공항대로 293', '지하 1층 105호', '서울특별시', '강서구', '등촌동', '07655', 37.558484, 126.861217, 24, '/example.com/seat-map', 0);