...
INSERT INTO seats (
    store_id, current_user_id, fixed_user_id, seat_number, start_at, expired_at, fixed_start_at, fixed_expired_at,
    seat_type, seat_status, created_at, updated_at
) VALUES
      (1, NULL, NULL, 1, NULL, NULL, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 2, NULL, NULL, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 3, NULL, NULL, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 4, NULL, NULL, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 5, NULL, NULL, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 6, NULL, NULL, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 7, NULL, NULL, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 8, NULL, NULL, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,1, 9, NULL, NULL, CURRENT_TIMESTAMP, DATEADD('HOUR', 3, CURRENT_TIMESTAMP), 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,2, 10, NULL, NULL, CURRENT_TIMESTAMP, DATEADD('HOUR', 3, CURRENT_TIMESTAMP), 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);