...
VALUES
    ('moo', '홍길동', '든든한 한끼를 드립니다', '02-1234-5678', CURRENT_TIMESTAMP, CAST('09:00:00' AS TIME), CAST('22:00:00' AS TIME), 0, '123-45-67890', '서울특별시 강서구 공항대로 293', '지하 1층 105호', '서울특별시', '강서구', '등촌동', '07655', 37.558484, 126.861217, 10, 'https://example.com/seat-map.png', 0);


INSERT INTO seats (
    store_id, current_user_id, fixed_user_id, seat_number, start_at, expired_at,
    seat_type, seat_status, created_at, updated_at
) VALUES
      (1, NULL, NULL, 1, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 2, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 3, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 4, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 5, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 6, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 7, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 8, NULL, NULL, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 9, NULL, NULL, 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (1, NULL,NULL, 10, NULL, NULL, 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);